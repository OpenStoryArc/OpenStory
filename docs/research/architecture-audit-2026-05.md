...
| 9 | **Federation hub→nodes mirror gap**: faithful lab — hub 10/10 but slowest node 8/10 (stalled). "Every machine sees all team data" not met at scale | High | ⚠️ **OPEN** — documented, root cause to confirm | `b2d891e` (red spec) |
